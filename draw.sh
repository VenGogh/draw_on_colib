pip3 install -q
https://github.com/camenduru/stable-diffusion-webui-colab/releases/download/0.0.15/xformers-0.0.15+e163309.d20230103-cp38-cp38-linux_x86_64.whl
pip3 install xformers
pip3 install triton
git clone https://github.com/VenGogh/stable-diffusion-webui.git
...
python /content/stable-diffusion-webui/launch.py --share --gradio-auth oookki:oookky --xformers 
